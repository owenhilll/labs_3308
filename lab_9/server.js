...
app.get('/home/pick_color', function(req, res) {
	...
	var color_msg = "select color_msg from favorite_colors where name = 'color_options';";
...
app.get('/player_info/post',function(req, res){
			var player_id = req.query.player_choice; //parameter
			
			var queryA = 'select * from football_players;';
			
			var player_query2 = "select * from football_players where id = '" + player_id + "';";
			...
			return task.batch([
			    task.any(queryA),
			    task.any(player_query2),
			    task.one(games_played)
			   ]);
			})
			.then(info => {
				res.render('pages/player_info',{
